      ...
      <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Courses Enrolled</span>
                <span class="info-box-number">{{ $stats->enrollments }}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
<div class="info-box-content">
  ...
  <span class="info-box-number">{{ $stats->reviews}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
<div class="info-box-content">
  ...
  <span class="info-box-number">{{ $stats->payments}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
