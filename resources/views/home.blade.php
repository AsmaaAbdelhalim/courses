...
@section('content')
                    ...
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            <div class="d-flex justify-content-between mb-3">
                                <small class="m-0"><i class="fa fa-users text-primary mr-2"></i>{{ $course->enrollment->count()}} Students</small>
    ...
    <!-- <div>
    <h2>Most Enrolled Courses in Laravel Category</h2>
    <ul>
        (mostEnrolledCourses as course)
            <li> course name  -  course-enrollment_count  enrollments</li>
