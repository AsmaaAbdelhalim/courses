  ...
  html, body {
    ...
    <p>progress:{{ $progress }}%</p>
            ...
            <video width="800" height="400" controls autoplay>
                <source src="{{ asset('storage/' . $path['videos'] . '/' . $lesson->videos) }}" type="video/mp4">
            ...
            @if($lesson->image)
            <img class="img-fluid" style="height: 300px; width: 400px;" src="{{ asset('storage/' . $path['image'] . '/' . $lesson->image) }}" alt="{{ $lesson->title }}">
            @endif
